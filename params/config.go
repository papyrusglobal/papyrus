...
type ChainConfig struct {
	...
	// EIP150 implements the Gas price changes (https://github.com/papyrusglobal/EIPs/issues/150)
	...
	Papyrus *PapyrusConfig `json:"papyrus,omitempty"`
}
...
// String implements the stringer interface, returning the consensus engine details.
func (c *PapyrusConfig) String() string {
	return "papyrus"
}
