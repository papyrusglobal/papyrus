...
//
// Detailed usage document and tutorial available on the papyrus Wiki page:
// https://github.com/papyrusglobal/papyrus/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
