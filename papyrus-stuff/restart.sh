...
cp config/account.3.json $DATADIR.3/keystore/
...
$GETH5 init config/genesis.json
cp config/nodekey.5 $DATADIR.5/geth/nodekey
cp config/static-nodes.json $DATADIR.5/
