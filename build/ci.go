...
import (
	...
	"github.com/papyrusglobal/papyrus/internal/build"
	"github.com/papyrusglobal/papyrus/params"
	sv "github.com/papyrusglobal/papyrus/swarm/version"
)
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("papyrus requires at least Go version 1.9 and cannot")
...
type debMetadata struct {
	...
	// papyrus version being built. Note that this
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/papyrusglobal/papyrus/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/papyrusglobal/papyrus/mobile")
